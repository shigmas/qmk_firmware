...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* Base */
    ...
    ADJUST,           KC_PSCR,            KC_LGUI,          LALT_T(KC_LBRC),  LT(_LOWER,KC_MINS), KC_SPC,

    KC_6,             KC_7,               KC_8,             KC_9,             KC_0,               KC_BSPC,
    KC_Y,             KC_U,               KC_I,             KC_O,             KC_P,               KC_BSLS,
    KC_H,             KC_J,               KC_K,             KC_L,             KC_SCLN,            KC_ENT,
    KC_N,             KC_M,               KC_COMM,          KC_DOT,           KC_UP,              RSFT_T(KC_SLSH),
    KC_ENT,           LT(_RAISE,KC_EQL),  RALT_T(KC_RBRC),  KC_LEFT,          KC_DOWN,            KC_RGHT
  ),
  [_LOWER] = LAYOUT(
